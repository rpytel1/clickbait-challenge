...
def calculate_all_behaviour_features(entry):
    ...
    behaviour_article_title_feats = ['@_in_article_title', '!_in_article_title', '#_in_article_title', '?_in_article_title']
    ...
    behaviour_article_keywords_feats = ['@_in_article_keywords', '!_in_article_keywords', '#_in_article_keywords', '?_in_article_keywords']
    behaviour_post_captions = calculate_special_signs(" ".join(entry["targetCaptions"]))
    behaviour_article_captions_feats = ['@_in_article_captions', '!_in_article_captions', '#_in_article_captions', '?_in_article_captions']
    behaviour_post_paragraphs = calculate_special_signs(" ".join(entry["targetParagraphs"]))
    behaviour_article_paragraphs_feats = ['@_in_article_paragraphs', '!_in_article_paragraphs', '#_in_article_paragraphs', '?_in_article_paragraphs']
    ...
    return [behaviour_post_title, behaviour_post_image, behaviour_article_title, \
           ...
           behaviour_post_title_feats + behaviour_post_image_feats + behaviour_article_title_feats + \
