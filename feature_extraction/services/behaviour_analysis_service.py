...
def get_feat_names():
    behaviour_post_title_feats = ['@_in_post_title', '!_in_post_title', '#_in_post_title', '?_in_post_title', 'links_in_post_title']
    behaviour_post_image_feats = ['@_in_post_image', '!_in_post_image', '#_in_post_image', '?_in_post_image', 'links_in_post_image']
    behaviour_article_title_feats = ['@_in_article_title', '!_in_article_title', '#_in_article_title',
                                     '?_in_article_title', 'links_in_article_title']
    behaviour_article_desc_feats = ['@_in_article_desc', '!_in_article_desc', '#_in_article_desc', '?_in_article_desc', 'links_in_article_desc']
    ...
    behaviour_article_paragraphs_feats = ['@_in_article_paragraphs', '!_in_article_paragraphs',
                                          '#_in_article_paragraphs', '?_in_article_paragraphs', 'links_in_article_paragraphs']
...
def calculate_special_signs(text):
    ...
    return text.count("@"), text.count("!"), text.count("#"), text.count("?"), len(tokenizer.tokenize(text))
